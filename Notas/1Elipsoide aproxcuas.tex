...
\begin{figure}[H]
	\centering
	\sidesubfloat[][a]{\includegraphics[width=0.45\textwidth]{../../Figuras/ellipsoid}\label{elipse}}
	\sidesubfloat[][b]{\includegraphics[width=0.45\textwidth]{../../Figuras/quadraticonfo}\label{Quadrics}}
...
\noindent Asimismo, se propone descomponer al potencial $\phi_{ext}$ en una contribución de la onda plana incidente $\phi_0$ y en otra de perturbación $\phi_p$, la cual correspondería al campo eléctrico esparcido por la partícula
\begin{equation}
